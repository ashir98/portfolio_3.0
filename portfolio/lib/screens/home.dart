                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            await launchUrl(Uri.parse(accountUrl.instaUrl),
                        ...
                        GestureDetector(
                          onTap: () async {
                            await launchUrl(Uri.parse(accountUrl.linkedinUrl),
                                mode: LaunchMode.externalApplication);
                          },
                          child: Icon(
                        ...
                        GestureDetector(
                          onTap: () async {
                            await launchUrl(Uri.parse(accountUrl.youtubeUrl),
                                mode: LaunchMode.externalApplication);
                          },
                          child: Icon(
                        ...
                        GestureDetector(
                          onTap: () async {
                            await launchUrl(Uri.parse(accountUrl.githubUrl),
                                mode: LaunchMode.externalApplication);
                          },
                          child: Icon(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              await launchUrl(Uri.parse(accountUrl.cvUrl),
                                  mode:
                        ...
                        SizedBox(
                          ...
                          child: Card(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () async {
                                await launchUrl(
                                    Uri.parse(accountUrl.whatsappUrl),
                                    mode: LaunchMode
                        ...
                        Container(
                          ...
                          child: Card(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () async {
                                await launchUrl(
                                    Uri.parse(accountUrl.messengerUrl),
                                    mode: LaunchMode.externalApplication);
                              },
                            ),
                          ),
